...
# Немного про удаленный репозиторий

### Несколько новых функций:

1. git clone - делает локальную копию удаленного репозитария
2. git pull - "стянуть/выкачать" изменения из удаленного репозитория
3. git push - отправляем изменения в удаленный репозиторий
4. fork - копия ручного репозитория с сайта GitHub
